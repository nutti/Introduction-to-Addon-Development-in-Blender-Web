...
class SOEM_Preferences(bpy.types.AddonPreferences):
    ...
    translate = EnumProperty(
        name="Translate",
        description="並進移動の処理を行うショートカットキー",
        items=key_pref_list,
        get=get_pref_translate,
        set=set_pref_translate)
    scale = EnumProperty(
        name="Scale",
        description="拡大・縮小の処理を行うショートカットキー",
        items=key_pref_list,
        get=get_pref_scale,
        set=set_pref_scale)
    rotate = EnumProperty(
        name="Rotate",
        description="回転の処理を行うショートカットキー",
        items=key_pref_list,
        get=get_pref_rotate,
        set=set_pref_rotate)
    x_axis = EnumProperty(
        name="X軸",
        description="X軸に関する処理を行うショートカットキー",
        items=key_pref_list,
        get=get_pref_x_axis,
        set=set_pref_x_axis)
    y_axis = EnumProperty(
        name="Y軸",
        description="Y軸に関する処理を行うショートカットキー",
        items=key_pref_list,
        get=get_pref_y_axis,
        set=set_pref_y_axis)
    z_axis = EnumProperty(
        name="Z軸",
        description="Z軸に関する処理を行うショートカットキー",
        items=key_pref_list,
        get=get_pref_z_axis,
        set=set_pref_z_axis)
    increment = EnumProperty(
        name="+",
        description="インクリメント方向の操作を行うショートカットキー",
        items=key_pref_list,
        get=get_pref_increment,
        set=set_pref_increment)
    decrement = EnumProperty(
        name="-",
        description="デクリメント方向の操作を行うショートカットキー",
        items=key_pref_list,
