...
本節では前回解説した内容を理解していることを前提に新たなサンプルを用いて解説していきます。
既に解説済みの部分は解説を省略しますので、不明な点が生じたら [2-1節](01_Sample_1_Create_object_from_Add-on.md)
を再度確認することをお勧めします。
...
Blender起動直後には **Cube** が生成されているはずなので選択し、
 **3Dビュー** の **オブジェクト** > **選択オブジェクトの拡大** を実行してみましょう。
