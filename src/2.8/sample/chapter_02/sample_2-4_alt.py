...
class SAMPLE24_OT_TranslateObject(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        self.report({'INFO'}, "サンプル2-4: 『{}』を{}軸方向へ {} 並進移動しました。"
                              .format(obj.name, self.axis, self.amount))
        print("サンプル2-4: オペレータ『{}』が実行されました。".format(self.bl_idname))

        return {'FINISHED'}


# @include-source start [sub_menu_cls]
# サブメニュー
    ...
    def draw(self, context):
        ...
        for o in bpy.data.objects:
            if o.type == 'MESH':
                ...
                ops.obj_name = o.name
# @include-source end [sub_menu_cls]


# @include-source start [main_menu_cls]
# メインメニュー
...
# @include-source end [main_menu_cls]
