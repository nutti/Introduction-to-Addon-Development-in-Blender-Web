import bpy
# @include-source start [import_bgl]
import bgl
# @include-source end [import_bgl]
...
# @include-source start [panel_class]
...
# @include-source end [panel_class]
