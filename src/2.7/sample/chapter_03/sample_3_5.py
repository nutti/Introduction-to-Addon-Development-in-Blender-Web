...
# @include-source end [remove_render_func]

# @include-source start [render_text]
    @staticmethod
    def __render_text(size, x, y, s):
        ...
        # テキストを描画
        blf.draw(0, s)
# @include-source end [render_text]
...
# @include-source start [call_render_region]
        # 描画先のリージョンへテキストを描画
...
# @include-source end [call_render_region]
