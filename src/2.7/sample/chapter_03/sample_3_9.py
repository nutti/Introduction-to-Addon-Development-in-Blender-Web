...
# @include-source start [import_view3d_utils]
from bpy_extras import view3d_utils
# @include-source end [import_view3d_utils]
...
# @include-source start [check_intersection]
...
# @include-source end [check_intersection]

# @include-source start [select_object]
        # レイと交差したオブジェクトを選択
        for o in bpy.data.objects:
            o.select = True if o in self.__intersected_objs else False
# @include-source end [select_object]
