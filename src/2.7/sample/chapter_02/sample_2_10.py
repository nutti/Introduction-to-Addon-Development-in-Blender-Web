...
# @include-source start [ops_show_popup_message]
class ShowPopupMessage(bpy.types.Operator):
    ...
    def draw(self, context):
        layout = self.layout
        layout.label("メッセージ")
# @include-source end [ops_show_popup_message]


# @include-source start [ops_show_dialog_menu]
...
# @include-source end [ops_show_dialog_menu]


# @include-source start [ops_show_file_browser]
...
# @include-source end [ops_show_file_browser]


# @include-source start [ops_show_confirm_popup]
...
# @include-source end [ops_show_confirm_popup]


# @include-source start [ops_show_property_popup]
...
# @include-source end [ops_show_property_popup]


# @include-source start [ops_show_search_popup]
class ShowSearchPopup(bpy.types.Operator):
    ...
    def invoke(self, context, event):
        ...
        # {'FINISHED'} を返す必要がある
        return {'FINISHED'}
# @include-source end [ops_show_search_popup]
...
# @include-source start [show_popup_message]
        # ポップアップメッセージを表示する
        layout.label(text="ポップアップメッセージを表示する:")
        layout.operator(ShowPopupMessage.bl_idname)
# @include-source end [show_popup_message]

        layout.separator()

# @include-source start [show_dialog_menu]
        # ダイアログメニューを表示する
        layout.label(text="ダイアログメニューを表示する:")
        layout.operator(ShowDialogMenu.bl_idname)
# @include-source end [show_dialog_menu]

        layout.separator()

# @include-source start [show_file_browser]
        # ファイルブラウザを表示する
        layout.label(text="ファイルブラウザを表示する:")
        layout.operator(ShowFileBrowser.bl_idname)
# @include-source end [show_file_browser]

        layout.separator()

# @include-source start [show_confirm_popup]
        # 確認ポップアップを表示する
        layout.label(text="確認ポップアップを表示する:")
        layout.operator(ShowConfirmPopup.bl_idname)
# @include-source end [show_confirm_popup]

        layout.separator()

# @include-source start [show_property_popup]
        # プロパティ付きポップアップを表示する
        layout.label(text="プロパティ付きポップアップを表示する:")
        layout.operator(ShowPropertyPopup.bl_idname)
# @include-source end [show_property_popup]

        layout.separator()

# @include-source start [show_search_popup]
        # 検索ポップアップを表示する
        layout.label(text="検索ポップアップを表示する:")
        layout.operator(ShowSearchPopup.bl_idname)
# @include-source end [show_search_popup]
