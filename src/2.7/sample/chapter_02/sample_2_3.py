...
# @include-source start [prop_enlarge_object_2]
...
# @include-source end [prop_enlarge_object_2]
...
# @include-source start [prop_reduce_object_2]
...
# @include-source end [prop_reduce_object_2]
