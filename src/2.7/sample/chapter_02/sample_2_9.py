...
# @include-source start [customize_option_UI]
    # オプションのUI
    def draw(self, context):
        layout = self.layout
...
# @include-source end [customize_option_UI]
...
# @include-source start [add_menu]
        # メニューを追加
        layout.label(text="メニューを追加する:")
        layout.menu(NullOperationMenu.bl_idname, text="メニュー")
# @include-source end [add_menu]

        layout.separator()

# @include-source start [add_prop]
        # プロパティを追加
