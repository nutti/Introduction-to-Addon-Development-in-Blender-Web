...
# @include-source start [op_enlarge_object]
# オブジェクトを拡大するオペレーション
...
# @include-source end [op_enlarge_object]

# @include-source start [execute_enlarge_object]
    # メニューを実行した時に呼ばれるメソッド
    def execute(self, context):
        ...
        return {'FINISHED'}
# @include-source end [execute_enlarge_object]


# @include-source start [op_reduce_object]
# オブジェクトを縮小するオペレーション
class ReduceObject(bpy.types.Operator):
    ...
    bl_options = {'REGISTER', 'UNDO'}
# @include-source end [op_reduce_object]

# @include-source start [execute_reduce_object]
    # メニューを実行した時に呼ばれる関数
    def execute(self, context):
        active_obj = context.active_object
        ...
        return {'FINISHED'}
# @include-source end [execute_reduce_object]
